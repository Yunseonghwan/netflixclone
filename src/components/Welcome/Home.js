...
export default () => (
  <Welcome>
    ...
    <IntroductionContainer>
      ...
      <div>
        <span>
          저는 개발은 무한한 가능성이있다고 생각합니다. 그래서 저의 목표는 선배
          개발자들 처럼 많은 지식과 경험을 쌓고 거기서 더 발전해 나가며 후배
          개발자들에게 도움이 되는것입니다.
        </span>
      </div>
      <div>
        <span>
          이 사이트는 저의 소개 사이트겸 넷플릭스 클론 코딩한 포트폴리오입니다.
        </span>
      </div>
      <div>
        <span>
          먼저 첫페이지는 제 소개 페이지입니다. 보시고 로그인버튼을 누르시면 제
          포트폴리오를 보실 수 있습니다.
        </span>
      </div>
      <div>
